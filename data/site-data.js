...
window.SITE_DATA = {
  ...
  greeting: {
    show: true,
    // 인사말 아래에 들어가는 사진 (지금은 임직원 단체 사진)
    photo: "assets/img/staff.jpg",
    // ⚠️ 사진 속 인물이 임직원이 아니라고 하셔서 설명을 비웠습니다.
    //    누구인지 알려주시면 넣겠습니다. (예: "제작팀과 함께")
    photoAlt: "제천킹스파찜질방 사우나에서 찍은 기념 사진",
    photoCaption: "",
    label: "",                       // 제목을 「인사말」로 쓰므로 작은 머리말은 비웁니다

    // 손으로 쓴 인사말을 스캔해서 넣을 자리입니다.
    // 파일을 assets/img/greeting-hand.png 로 넣고 아래 경로를 적으면
    // 글씨 대신 그 사진이 나옵니다. 비워 두면 아래 body 글이 나옵니다.
    // ※ 사진을 넣어도 body 글은 지우지 마세요.
    //   사진 속 글자는 검색엔진과 화면낭독기가 읽지 못해서,
    //   화면에는 안 보이지만 기계는 읽는 글로 함께 넣습니다.
    handwriting: "",
    // 사장님 글이 「안녕하십니까」로 시작하는 완결된 인사말이라
    // 그 위에 따로 제목을 붙이지 않고 섹션 이름만 둡니다.
    title: "인사말",
    body: [
      "안녕하십니까. 제천 킹스파 찜질방 홈페이지를 찾아주신 여러분을 진심으로 환영합니다.",
      "저희는 1998년 찜질방 사업을 시작한 이래, 목욕과 휴식이 특별한 날의 호사가 아니라 누구나 일상에서 누리는 문화가 되기를 바라며 한길을 걸어왔습니다. 그렇게 쌓아온 28년의 경험은 지금도 저희가 매일 시설을 점검하고 서비스를 다듬는 기준이 되고 있습니다.",
      "사우나와 찜질방, 헬스장을 갖춘 저희 킹스파는 제천 시민과 이곳을 찾아주시는 관광객 여러분께 편안한 쉼과 즐거움을 함께 드리는 공간이 되고자 합니다. 이를 위해 40여 명의 임직원이 한마음으로 정성을 다하고 있습니다.",
      "착한가격과 맛집명성을 지켜 나가는 것은 물론, 한식과 피자, 후라이드 치킨, 디저트에 이르기까지 머무시는 시간이 더욱 풍요로워지도록 정성껏 준비하겠습니다. 제천을 대표하는 휴식 명소로 자리매김할 수 있도록 한 걸음씩 나아가겠습니다.",
      "찾아주시는 모든 분들의 건강과 행복을 기원합니다.",
      "감사합니다.",
    ],
    sign: "제천킹스파찜질방 대표 김동술",
    signImage: "assets/img/sign.png",   // 손으로 쓰신 서명 (비우면 안 나옵니다)
  },
