...
window.SITE_DATA = {
  ...
  pricing: {
    ...
    // 헬스 + 사우나 회원권 — 매장 안내판 그대로
    // ⚠️ 안내판 제목이 「구정 맞이 특별 회원 모집」이었습니다. 특가 기간이 끝났다면
    //    금액을 고쳐 주세요. 기간이 정해져 있으면 note 에 적어두면 좋습니다.
    membership: {
      show: true,
      title: "헬스 + 사우나 회원권",
      desc: "기간 동안 헬스장과 사우나를 함께 이용하시는 회원권입니다.",
      items: [
        { name: "1개월", price: "129,000원", note: "찜질방 추가 불가" },
        { name: "3개월", price: "360,000원", note: "찜질방 4,000원 별도" },
        { name: "6개월", price: "590,000원", note: "찜질방 4,000원 별도" },
        { name: "1년",   price: "990,000원", note: "찜질방 4,000원 별도" },
      ],
      rules: [
        "회원권은 본인만 사용하실 수 있습니다.",
        "하루 한 번 입장하실 수 있습니다.",
        "다른 분께 양도하거나 되파실 수 없습니다.",
        "회원 문의는 카운터로 해주세요.",
      ],
    },
  },
  ...
  sleep: {
    ...
    title: "수면방",
    sub: "밤새 머무시는 분께",
    lead: { src: "assets/img/sleep.jpg", alt: "나무 칸막이로 나뉜 2층 침상이 줄지어 선 수면방" },
    ...
    info: [
      { t: "남녀 구분", d: "남자 수면방과 여자 수면방이 따로 있습니다." },
      { t: "안전",     d: "통로에 CCTV가 있습니다." },
    ],
  },
  ...
  menu: {
    ...
    groups: [
      ...
      {
        name: "스타벅스",
        desc: "캡슐 커피 자판기입니다. 24시간 이용하실 수 있습니다. 차갑게 드시려면 얼음컵을 300원에 더하시면 됩니다.",
        photos: [
          { img: "coffee.jpg",   name: "스타벅스 캡슐 커피 자판기" },
          { img: "coffee-2.jpg", name: "자판기 · 냉장 쇼케이스" },
        ],
        // 자판기 화면의 「커피」 칸에 적힌 그대로입니다.
        // 라떼 · 차 · 에이드 칸도 기계에 있지만 넣지 않기로 했습니다 (사업주 요청).
        items: [
          { name: "스타벅스 하우스 블렌드",     price: "3,500원" },
          { name: "스타벅스 베란다 블렌드",     price: "3,500원" },
          { name: "캐빈잇 아메리카노",          price: "3,000원" },
          { name: "아메리카노 클래식 (투샷)",   price: "3,000원" },
          { name: "아메리카노 디카페인 (투샷)", price: "3,500원" },
        ],
      },
      {
