...
window.SITE_DATA = {
  ...
  pricing: {
    ...
    extras: [
      // 매장 요금표에 「6시간 초과 시」라고 적혀 있습니다.
      // 기존에는 6시간이 빠져 있어 처음부터 10분마다 돈을 받는 것처럼 읽혔습니다.
  ...
  // ⚠️ 문구는 실제로 받고 계신 서비스에 맞게 고쳐 주세요.
  //    배지에는 해충·바이러스·공기·수질 아이콘이 모두 있지만,
  //    가입 항목이 다르면 아래 items 에서 빼시면 됩니다.
  hygiene: {
    show: true,
    badge: "assets/img/cesco.png",
    badgeAlt: "세스코 멤버스 인증 마크",
    eyebrow: "CESCO MEMBERS",
    title: "위생은 세스코가 관리합니다",
    desc: "많은 분이 오가는 곳이라 청결이 가장 중요합니다. 세스코 멤버스에 가입해 정기적으로 점검받고 있습니다.",
    items: ["해충 방제", "바이러스 케어", "공기 관리", "수질 관리"],
  },
