...
window.SITE_DATA = {
  ...
  info: {
    ...
    // ⚠️ 사업자 정보 (홈페이지 표기 권장) — 확인 후 입력
    ceo: "김동술",
    bizNumber: "",                   // 예: "123-45-67890"
  },
  ...
  pricing: {
    ...
    childNote: "소인 = 미취학 아동 기준",
    extras: [
      { label: "야간할증",   value: "22:00 ~ 05:00 · 1,000원 추가" },
      { label: "초과 이용",  value: "10분당 200원" },
    ],
    passes: [
    ...
    groups: [
      {
        ...
        items: [
          { name: "미역국",            price: "9,000원" },
          { name: "김치찌개",          price: "9,900원" },
          { name: "해물 순두부찌개",    price: "9,900원" },
          { name: "파불고기",          price: "10,900원" },
          { name: "제육볶음",          price: "9,900원" },
          { name: "낙지볶음",          price: "9,900원" },
          { name: "오징어볶음",        price: "9,900원" },
          { name: "돼지김치 두루치기",  price: "9,900원" },
          { name: "국물떡볶이",        price: "9,900원" },   // ⚠️ 메뉴판에 6,900 정정 표시가 있었습니다. 확인 부탁드립니다
          { name: "통등심 돈까스",      price: "9,900원" },
          { name: "김치전",            price: "7,000원" },
          { name: "부추전",            price: "7,000원" },
        ],
      },
      {
        name: "화락",
        ...
        items: [
          { name: "직화소금바베큐치킨",    price: "22,900원" },
          { name: "직화간장바베큐치킨",    price: "22,900원" },
          { name: "직화고추장바베큐치킨",  price: "22,900원" },
          { name: "직화버터바베큐치킨",    price: "22,900원" },
          { name: "직화땡초바베큐치킨",    price: "22,900원" },
          { name: "직화소금구이치밥",      price: "9,900원" },
          { name: "직화간장치밥",          price: "9,900원" },
          { name: "직화고추장치밥",        price: "9,900원" },
          { name: "직화버터치밥",          price: "9,900원" },
          { name: "직화땡초치밥",          price: "9,900원" },
        ],
      },
      {
        name: "남자피자",
        ...
        items: [
          { name: "남자피자",              price: "19,800원" },
          { name: "오리지널피자",          price: "23,900원" },
          { name: "불고기피자",            price: "23,900원" },
          { name: "애플고르곤졸라",        price: "23,900원" },
          { name: "베이컨포테이토",        price: "23,900원" },
          { name: "스파이시 하와이안피자",  price: "23,900원" },
          { name: "옥수수피자",            price: "23,900원" },
          { name: "크림치즈엣지 추가",      price: "2,900원" },
          { name: "고구마엣지 추가",        price: "2,900원" },
          { name: "치즈크러스트 추가",      price: "4,000원" },
        ],
      },
      {
        name: "KC치킨",
        ...
        items: [
          { name: "후라이드치킨",   price: "20,000원" },
          { name: "양념치킨",       price: "22,000원" },
          { name: "골뱅이소면",     price: "17,000원" },
          { name: "먹태",           price: "19,000원" },
          { name: "노가리 & 땅콩",  price: "19,000원" },
          { name: "오징어 & 땅콩",  price: "22,000원" },
          { name: "황도",           price: "10,000원" },
        ],
      },
      {
        name: "매점",
