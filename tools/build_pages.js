...
const PAGES = [
  ...
  },
  {
    ...
    desc: '발권부터 찜질까지 순서대로 안내합니다. 남녀 구분, 준비물, 퇴실 처리, 어린이 동반, 주차 안내.',
    ...
    faq: [
      ...
      { q: '신발장을 열면 어떻게 되나요?',
        a: '신발장을 여시면 그 시점에 퇴실 처리됩니다. 다시 들어오실 때는 새로 발권하셔야 하니 주의해 주세요.' },
      { q: '아이와 함께 가도 되나요?',
...
${PAGES.map((p) => `        <a href="/${p.slug}/">${p.nav}</a>`).join('\n')}
    ...
    <div class="ft__by"><img src="/assets/img/onleave.png" alt="onleave" width="760" height="80" loading="lazy"></div>
  </div>
</footer>
