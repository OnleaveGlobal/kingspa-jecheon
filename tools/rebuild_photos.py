...
MAP = {
    ...
    # ── 청풍 휴게실 (시설 카드 한 장) ───────────────────────
    "cheongpung.jpg": ("MH_07550", 5 / 4, 900, .50),
    # 섹션을 따로 두었다 카드 한 장으로 줄이면서 아래 넉 장은 뺐습니다.
    # 다시 쓰시려면 앞의 # 만 지우면 원본에서 그대로 만들어집니다.
    # "cheongpung-1.jpg": ("MH_07569", 5 / 4, 900, .50),  # 침상 한 칸
    # "cheongpung-2.jpg": ("MH_07568", 5 / 4, 900, .50),  # 남 · 여 구분 표시
    # "cheongpung-3.jpg": ("MH_07575", 5 / 4, 900, .50),  # 침상 안쪽 (베개)
    # "cheongpung-4.jpg": ("MH_07567", 5 / 4, 900, .50),  # 침상 사이 통로
}
